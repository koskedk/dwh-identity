                                ...
                                <tr style = 'border-collapse: collapse;'>
                                  <td
                                    ...
                                    <p style='
                                        ...
                                        line-height: 27px;
                                        color: #666666;'>
                                      Dear { steward.FullName },
                                      <br />
                                      Name: { (UserType)user.Title }, { user.FullName } 
                                    </p>
                                    <p style='
                                        margin: 0;
                                        mso-line-height-rule: exactly;
                                    ...
                                    <p style='
                                        ...
                                        font-size: 18px;
                                        line-height: 27px;
                                        color: #666666;'><em>Reason for access: { user.ReasonForAccessing }</em></p>
                                    <p style='
                                        margin: 0;
                                        mso-line-height-rule: exactly;
                                        font-size: 18px;
                                        line-height: 27px;
                                        color: #666666;'>The above mentioned has created an account on the Integrated Data Warehouse portal and is requesting affiliation to <strong>{organization.Name}'s</strong> data and access privileges.</p>
                                    <p style='
                                        margin: 0;
                                        mso-line-height-rule: exactly;
                                        font-size: 18px;
                                        line-height: 27px;
                                        color: #666666;'>To confirm this affiliation and grant access to this request please log into the National Datawarehouse portal <a href={callbackUrl}>here</a> and grant access.</p>
                                    <p style='
                                        margin: 0;
                                        mso-line-height-rule: exactly;
                                        font-size: 18px;
                                    ...
                                    <p style='
                                        ...
                                        font-size: 18px;
                                        line-height: 27px;
                                        color: #666666;'>If the above individual is not affiliated to your organisation you can choose to ignore this message and do nothing. </p>
                                    <p style='
                                        margin: 0;
                                        mso-line-height-rule: exactly;
                                        font-size: 18px;
                                        line-height: 27px;
                                        color: #666666;'>If you have any questions/concerns please contact Administrator on Koske.Kimutai@thepalladiumgroup.com</p>
                                    <p style='
                                        margin: 0;
                                        mso-line-height-rule: exactly;
                                        font-size: 18px;
